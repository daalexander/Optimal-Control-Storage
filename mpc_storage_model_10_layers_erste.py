...
data2 = sim_est.simulation_results
# data2 = pd.data
# data2.to_csv('/home/da/Master/Thesis/Optimal-Control-Storage/mpc/' + 'mpc' + str(datatable) + 'start' + str(int_start) + '.csv', sep= ",")
np.savetxt('/home/da/Master/Thesis/Optimal-Control-Storage/mpc/' + 'mpc' + str(datatable) + 'start' + str(int_start) + '.csv',data2 ,delimiter=',')
